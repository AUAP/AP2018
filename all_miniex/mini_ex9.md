...
4. For the **group** work:
  ...
  - In the readme file:
    ...
    - Individual: If you have to bring the concept of algorithms from flow charts in a wider cultural context, how would you reflect the notion of algorithms? (see if you could refer to the text and articule your thoughts?)
